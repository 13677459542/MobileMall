    ...
    public class JwtHelper
    {
        ...
        public string CreateToken(TokenModelJwt model)
        {
            ...
            var jwtSecurityToken = new JwtSecurityToken(
                ...
                DateTime.Now.AddMinutes(15),      //expires 到期时间
                ...
                }).AddJwtBearer(options =>
                {
                    ...
                    options.Events = new JwtBearerEvents
                    {
                        ...
                        OnChallenge = async context =>
                        {
                            ...
                            string result = JsonConvert.SerializeObject(new BaseResp<string> { status = 401, message = "接口未授权,请登录授权服务获取Token" });
                        ...
                        OnForbidden = async context =>
                        {
                            ...
                            string result = JsonConvert.SerializeObject(new BaseResp<string> { status = 403, message = "不允许访问服务" });
                            await context.Response.WriteAsync(result);
                            //return Task.FromResult(0);
                        }
                    };
